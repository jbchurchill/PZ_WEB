...
var dojo, getExtent, require, doFind, esri, document, dijit;
var map, center, zoom;
var grid, store;
...
require([
  ...
  var doZoom, popup, scalebar, basemapGallery, console, initSelectToolbar, mdImagelayer, mdImageBasemap, imageParameters, visibleLayerIds, landBaseLayer, sumSelectedParcelInfo, sumSelectedPoints, showResults, selectionToolbar;
  doZoom = 1;
  ...
  function initSelectToolbar (event) {
    var selectQuery, selectionToolbar;
    setupSelections();
    dojo.connect(map, "onExtentChange", getExtent);
