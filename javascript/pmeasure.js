...
require([
    ...
    map = new Map("map", { 
      basemap: "streets",
      // center: [Number(avgX), Number(avgY)], // center: [-79.23, 39.51],
      center: [avgX, avgY],
      // extent: passedExtent,
